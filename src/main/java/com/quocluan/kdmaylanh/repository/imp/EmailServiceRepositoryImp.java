package com.quocluan.kdmaylanh.repository.imp;

import com.quocluan.kdmaylanh.repository.IEmailServiceRepository;
...
public class EmailServiceRepositoryImp implements IEmailServiceRepository {
    ...
    private String fromEmail = "quocluan125@gmail.com";
...
//            mimeMessageHelper.addAttachment("logo.jpg", new ClassPathResource("logo.jpg"));
            ...
            Template t;
            if (subject.equals("Tài khoản truy cập của bạn đã được tạo")) {
